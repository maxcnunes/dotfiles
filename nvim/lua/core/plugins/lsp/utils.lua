...
M.toggle_virtual_text = function()
  ...
  utils.notify(string.format('Virtualtext %s', VIRTUAL_TEXT_ACTIVE and 'on' or 'off'), vim.log.levels.INFO, 'lsp/utils.lua')
...
M.toggle_autoformat = function()
  ...
  utils.notify(string.format('Autoformatting %s', AUTOFORMAT_ACTIVE and 'on' or 'off'), vim.log.levels.INFO, 'lsp.utils')
end
