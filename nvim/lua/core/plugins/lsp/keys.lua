...
M._keys = {
  ...
  { '<leader>ldf1', vim.lsp.buf.definition, desc = 'Goto Definition 1' },
  -- { "<leader>", vim.lsp.buf.definition, desc = "Goto Definition 2" },
  { '<leader>ldf2', "<cmd>lua require('telescope.builtin').lsp_definitions()<cr>", desc = 'Goto Definition 2' },
